...
export const OFFICIAL_MARKETPLACE_CATALOG: MarketplacePlugin[] = [
  { id: 'document-engine', name: 'Document Engine', version: '0.9.0', publisher: 'CrucibleBox', category: '文档与 AI', description: '本地 PDF、轻量 OCR、版面分流、公式 LaTeX、结构化解析、格式转换和 RAG 数据准备。', highlights: ['文本清洗与章节树', 'Markdown/LaTeX 输出', 'Chunk 与真实 PDF 拆分'], minHostVersion: '2.0.0-beta.8' },
