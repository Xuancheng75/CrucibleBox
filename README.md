...
- 正式插件清单以 `scripts/plugin-catalog.json` 为准，目前包含 Document Engine（0.2.1，支持最多 2000 页 PDF、流式任务预览、按页/章节切分、可选择切分输出文件夹、内置 CPU OCR 默认模型并支持镜像回退）、
