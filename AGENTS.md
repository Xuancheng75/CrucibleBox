...
- 当前基线（1.6.0）：宿主 36 文件/261 项、六插件 190 项、供应链 16 项测试全绿；数据库 schema v3（`plugins.sort_order`）；生产仅 better-sqlite3 单引擎（sql.js 降级为测试/离线恢复工具）；自动更新默认关闭，配置 GitHub Release 后启用。
